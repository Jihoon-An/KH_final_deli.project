...
<%--                                &lt;%&ndash;                            <fmt:parseDate value="${reviews.rev_writedate}" var="registered"&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                           pattern="yyyy-MM-dd HH:mm:ss"/>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                            <fmt:formatDate value="${registered}" pattern="yyyy년 MM월 dd일 a h:mm"/>&ndash;%&gt;--%>
<%--                            <div id="writeDate">&lt;%&ndash;작성일자 : &ndash;%&gt;--%>
<%--                                <fmt:parseDate value="${reviews.rev_writedate}"--%>
<%--                                               var="registered"--%>
<%--                                               pattern="yyyy-MM-dd HH:mm:ss"/>--%>
<%--                                <fmt:formatDate value="${registered}" pattern="yyyy.MM.dd"/></div>--%>
<%--                        </div>--%>
<%--                            &lt;%&ndash;<div id="reviewStar">별점 : ${reviews.rev_star}</div>&ndash;%&gt;--%>
<%--                            &lt;%&ndash;임시&ndash;%&gt;--%>
<%--                            &lt;%&ndash;                            <img src="/resources/img/review/84eae9ab-6e0d-4172-936c-e8d23c3b84ac_다운로드.jpg" style="width: 250px; height: 150px; margin-left: 20px;">&ndash;%&gt;--%>
<%--                            &lt;%&ndash;                            <img src="/resources/img/review/1bbefed6-5039-4683-9af7-6bfe7950ead5_ifsp.png" style="width: 250px; height: 150px;">&ndash;%&gt;--%>
...
<%--                            </c:when>--%>
<%--                        </c:choose>--%>
<%--                        <div class="filter_box" style="overflow-x: scroll">--%>
