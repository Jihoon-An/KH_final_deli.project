        ...
        <c:when test="${not empty store_list}">
          <c:forEach var="store_list" items="${store_list}">
            ...
            <div class="store_list d-inline-flex m-2">
              <div class="m-2"><img class="store_logo" src="https://shop-phinf.pstatic.net/20221209_61/1670570397926XRLOY_JPEG/%ED%8C%A8%EC%85%98%ED%83%80%EC%9A%B4_%ED%96%89%EC%82%AC%EB%B0%B0%EB%84%88%EC%9A%B4%EC%98%81%EA%B0%80%EC%9D%B4%EB%93%9C.jpg"></div>
                ${store_list.STORE_LOGO}
              <div class="m-2">
                <div>식당명</div>
                <div>별점 / [리뷰 개수] / 456m</div>
                <div>배달요금</div>
                <div>[메뉴]</div>
              </div>
            </div>
