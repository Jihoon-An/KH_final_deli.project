...
<main id="home">
    <ul>
        <li><a href="/storeSearch">식당검색</a></li>
        <li><a href="/member/header/destination">배달지선택페이지</a></li>
        <li><a href="/admin/review/selectReview">운영자리뷰로</a></li>
        <li><a href="/member/order">결제결과페이지로</a></li>
        <li><a href="/myPage/review/">일반회원-리뷰수정페이지로</a></li>
        <li><a href="/store">식당추가</a></li>
        <li><a href="/menu">메뉴추가</a></li>
        <li><a href="/">내주문내역보기-아직연결x</a></li>
    </ul>
    <c:choose>
        <c:when test="${loginEmail != null}">
            <div class="container">
                <marquee>
                    ...
                    <br>
                    <a href="/memberMain/toMemberMain">
                        <button>메인으로</button>
                    </a>
                    <br>
                    <h1>
                    ...
                    <h2>
                        <a href="/userMenu/toMyPage">
                            <button>마이페이지</button>
                        </a>
                    </h2>
                    <h1>
                        <a href="/basket">
                            <button>고추장바구니모를찾아서</button>
                        </a>
                    </h1>
                    <br><br><br>
                    <h3><a href="/account/withdrawal">
                        <button>꺼지셈 너 필요없음 이제</button>
                    </a></h3>
                </marquee>
            </div>
        </c:when>
                ...
                <div class="loginBox">
                    <form id="loginForm" action="/account/login" method="post">
                        ...
                        <input type="checkbox" id="emailSave" name="emailSave"
                               <c:if test="${not empty saved_email}">checked</c:if>>
                        <button>로그인</button>
                        <br><br>
