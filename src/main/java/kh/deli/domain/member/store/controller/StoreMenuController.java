...
public class StoreMenuController {
    ...
    @RequestMapping("/menu/{storeSeq}")
    public String toStoreMenu(@PathVariable("storeSeq") Integer store_seq, Model model) throws Exception {
